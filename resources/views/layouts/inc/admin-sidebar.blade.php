    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link {{ Request::is('admin/category') || Request::is('admin/add-category') || Request::is('admin/category') ? 'collapse active' : 'collapsed' }}"
                ...
                <div class="collapse  {{ Request::is('admin/category') || Request::is('admin/add-category') || Request::is('admin/category/*') ? 'show' : '' }}"
                ...
                <a class="nav-link collapsed {{ Request::is('admin/posts') || Request::is('admin/add-post') || Request::is('admin/posts') ? 'collapse active' : 'collapsed' }}"
                ...
                <div class="collapse {{ Request::is('admin/posts') || Request::is('admin/add-post') || Request::is('admin/posts/*') ? 'show' : '' }}"
